...
def simulateBusDCChargingStationIncome(numberOfDCCharger, numberOfBuses, batteryCapacity):
...
def iterate(iteration):
    ...
    j_previous_charge = 44
    j_previous_swap = 44
    for i in range(250,600,10):
        previousBusCharger = 0.001
        for j in range(j_previous_charge-12,j_previous_charge+56,1):
            thisBusCharger, thisBusDCCharger = simulateBusDCChargingStationIncome(23, j,i)
        ...
        for j in range(j_previous_swap-12,j_previous_swap+56,1):
            thisBusSwap, thisBusSwapper = simulateBusSwapperIncome(1, j,i)
