...
busSwappingIncomeDataFrame["income"] = busSwappingIncomeDataFrame["income"]*2
...
ax.set(ylabel= "Saturation Number", xlabel='Charging Power (kW)')
ax.legend(numpoints=1)

plt.tight_layout()
plt.savefig('charging_power_bus.pdf')
